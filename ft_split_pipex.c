...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/03/22 15:43:09 by jiwolee           #+#    #+#             */
/*   Updated: 2022/06/28 20:03:56 by jiwolee          ###   ########seoul.kr  */
/*                                                                            */
/* ************************************************************************** */
...
static char	**mk_arr(char const *s, char c)
{
	...
	arr = (char **)malloc(sizeof(char *) * (cnt + 2)); // 1 -> 2
	return (arr);
}
